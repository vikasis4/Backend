  ...
  return (
    <>
      <div className="condition-cont">
        <Helmet>
          <title>RankBoost - Terms and Conditions</title>
          <meta name="keywords" content="RankBoost terms and conditions guidance mentorship iit jee" />
          <meta name="description" content="By  visiting this rankboost page you can view terms and conditions of rankboost website which deals with guidance and mentorship for iit jee aspirants" />
        </Helmet>
